...
- User roles: `admin` (full access), `comm` (admin panel without factura access), `finan` (admin panel without credit authorization or delivery toggle), `vendedor` (order form)
